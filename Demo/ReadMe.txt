...
res\Toolbar.bmp
    此位图文件用于为工具栏创建平铺图像。
    初始工具栏和状态栏在 CMainFrame 类中构造。使用资源编辑器编辑此工具栏位图，并更新 Demo.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导创建一种文档类型和一个视图：

DemoDoc.h、DemoDoc.cpp - 文档
    这些文件包含 CDemoDoc 类。编辑这些文件以添加特殊文档数据并实现文件保存和加载（通过 CDemoDoc::Serialize）。

DemoView.h、DemoView.cpp - 文档视图
    这些文件包含 CDemoView 类。
    CDemoView 对象用于查看 CDemoDoc 对象。
